...
if __name__ == "__main__":
    ...
    metrics_tpr_05 = get_metrics(df['y_true'].values, df['y_pred'].values, tpr_threshold=0.5)
    metrics_tpr_08 = get_metrics(df['y_true'].values, df['y_pred'].values, tpr_threshold=0.8)
